...
import type { KanbanColumn, KanbanLoadDataResult, KanbanChangeEvent, KanbanMoveEvent, KanbanProps } from './types'
...
const emit = defineEmits<{
	...
	(e: 'item-moved', itemId: string | number, toColumnId: string | number, newPosition: number, item: any): void
}>()
...
watch(
	...
	([newData, newRawData]) => {
		if (newRawData) {
			...
			internalBoardData.value = { ...newData }
		}
	},
