...
const displaySubtitle = computed(() =>
  props.option.subtitleI18n ? $t(props.option.subtitleI18n) : props.option.subtitle
)
const displayDescription = computed(() =>
  props.option.descriptionI18n ? $t(props.option.descriptionI18n) : props.option.description
)
</script>
