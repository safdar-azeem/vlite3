...
import { APPSHELL_LAYOUT_KEY, type AppShellLayoutContext } from './useAppShell'
...
<template>
  <div class="vlite-app-layout flex flex-row w-full h-full bg-body overflow-hidden">
    <Transition
      ...
      <nav
        ...
        role="navigation"
        aria-label="Sidebar">
        <slot name="sidebar-header" v-if="$slots['sidebar-header']"></slot>
        <div
