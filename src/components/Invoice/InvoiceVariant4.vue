...
<template>
  <div
    ...
    <!-- Hero Header -->
    <div class="bg-gray-100" :class="compact ? 'p-5' : 'p-8 sm:p-10'">
      <div
        class="flex flex-col md:flex-row justify-between"
        :class="compact ? 'gap-4 mb-2' : 'gap-6 mb-6'">
        <div>
          <h1
            class="font-extrabold tracking-tight"
            :class="compact ? 'text-2xl mb-1' : 'text-3xl md:text-4xl mb-2'">
        ...
        <div class="flex flex-col md:items-end gap-2 text-right">
          <div
            ...
            :class="compact ? 'h-10 p-1 mb-1' : 'h-14 p-2 mb-2'">
            <img
              :src="d.brandLogo"
              :alt="d.brandName"
              class="h-full object-contain filter brightness-0 invert" />
          </div>
          <h2 v-if="d.brandName" class="font-bold" :class="compact ? 'text-base' : 'text-lg'">
            {{ d.brandName }}
          </h2>
        </div>
      </div>
    ...
    <div :class="compact ? 'p-5 sm:p-6' : 'p-8 sm:p-10'">
      <!-- Info Grid -->
      <div class="grid grid-cols-1 md:grid-cols-2" :class="compact ? 'gap-6 mb-6' : 'gap-10 mb-10'">
        ...
        <table class="w-full text-left whitespace-nowrap" :class="compact ? 'text-xs' : ''">
          ...
          <tbody class="divide-y divide-border/50">
            <tr
              ...
              <td class="font-medium text-foreground pr-4" :class="compact ? 'py-3' : 'py-4'">
              ...
              <td
                ...
                :class="compact ? 'py-3 text-xs' : 'py-4 text-sm'">
                <div v-if="item.discount !== undefined" class="flex flex-col items-end">
                  <Price :value="-item.discount" />
                  <span v-if="item.discountLabel" class="text-[9px] uppercase font-bold">{{
                    item.discountLabel
                  }}</span>
                </div>
                <span v-else>-</span>
              ...
              <td
                ...
                :class="compact ? 'py-3 text-sm' : 'py-4 text-sm'">
      ...
      <div
        ...
        :class="compact ? 'gap-6' : 'gap-10'">
        <div class="w-full md:w-1/2" :class="compact ? 'space-y-3' : 'space-y-4'">
          <div
            v-if="d.barcode"
        ...
        <div class="w-full md:w-1/3" :class="compact ? 'min-w-[200px]' : 'min-w-[240px]'">
    ...
    <div
      ...
      :class="compact ? 'py-2 px-5 sm:px-6 text-[10px]' : 'py-3 px-8 text-xs'">
