  ...
  <div class="space-y-12 pb-20">
    <div>
      ...
      <p class="text-gray-500">
        A flexible grid and list component with built-in pagination, empty states, and loading skeletons. Supports both slot-based and prop-based component rendering.
      </p>
    </div>

    <DemoSection title="Slot-based Rendering" :code="sourceCode">
      <p class="text-sm text-gray-500 mb-6">
        Render items and skeletons seamlessly using Vue templates. Ideal for quick layouts without creating separate components.
      </p>
      ...
      <div class="bg-gray-50/50 p-6 rounded-xl border border-dashed border-gray-300">
        ...
        >
          <template #skeleton>
            <div class="bg-card border border-border rounded-xl p-4 shadow-sm animate-pulse h-[116px] flex flex-col justify-between">
          ...
          <template #item="{ item }">
            <div class="bg-card border border-border rounded-xl p-4 shadow-sm hover:border-primary/50 transition-colors flex flex-col justify-between h-full">
              ...
              <div class="mt-4 flex items-center gap-2">
                <span class="px-2 py-1 bg-muted text-muted-foreground text-xs rounded-md font-medium">
                  {{ item.role }}
                </span>
              </div>
            </div>
    ...
    <DemoSection title="Component Prop-based Rendering" :code="sourceCode">
      <p class="text-sm text-gray-500 mb-6">
        Pass entire Vue components to `:item` and `:skeleton` props for cleaner templates and highly reusable code architecture.
      </p>
