...
const { toast, showToast, configure } = useNotifications()
...
const triggerToast = (
	...
	showToast(`Login Successful`, type, 3000, undefined, position)
}
	...
	<div class="space-y-10">
		...
		<div class="space-y-2">
			...
			<p class="text-gray-500">
				Global notification system with stacked layout and animations.
			</p>
		</div>
		...
		<section class="space-y-6">
			...
			<div class="p-6 border rounded-xl bg-gray-50 space-y-4">
				<p class="text-sm text-gray-500">
					Set the default position for all future toasts.
				</p>
				...
				<div class="pt-4 border-t">
					<Button
						@click="
							showToast('This uses the global default position')
						">
						Test Default Toast
					</Button>
				</div>
		...
		<section class="space-y-6">
			...
			<div class="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-2xl">
				...
				<Button @click="triggerToast('bottom-left', 'info')"
					>Bottom Left</Button
				>
				<Button @click="triggerToast('bottom-center', 'info')"
					>Bottom Center</Button
				>
				<Button @click="triggerToast('bottom-right', 'info')"
					>Bottom Right</Button
				>
			</div>
		</section>
		...
		<section class="space-y-6">
			...
			<div class="flex flex-wrap gap-4">
				<Button
					variant="success"
					@click="triggerToast('bottom-right', 'success')"
					>Success</Button
				>
				<Button
					variant="danger"
					@click="triggerToast('bottom-right', 'error')"
					>Error</Button
				>
				<Button
					variant="outline"
					@click="triggerActionToast"
					>With Action & Desc</Button
				>
                <Button
					variant="outline"
					@click="triggerStack"
