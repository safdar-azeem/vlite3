...
const plans: ChoiceBoxOption[] = [
  {
    id: 'basic',
    title: 'Basic Plan',
    description: 'Perfect for starters. Includes basic features and community support.',
    icon: 'lucide:box',
    badge: 'Free',
  },
  {
    id: 'pro',
    title: 'Pro Plan',
    description: 'For growing businesses. Advanced analytics and priority support.',
    icon: 'lucide:zap',
    badge: 'Popular',
  },
  {
  ...
  <div class="space-y-8 p-4 max-w-6xl mx-auto">
    <div>
      ...
      <p class="text-gray-500 mb-6">
        A rich selection component for presenting options with titles, descriptions, and icons.
      </p>
    </div>
    ...
    <DemoSection title="Single Selection (Radio Style)" :code="sourceCode">
      <div class="p-6 border rounded-xl bg-gray-50/50">
        ...
        <div class="mt-6 text-sm text-gray-600 bg-white p-3 rounded border">
    ...
    <DemoSection title="Layout Options" :code="sourceCode">
      <div class="p-6 border rounded-xl bg-gray-50/50 space-y-6">
        <!-- Stacked list -->
        <div>
          <p class="text-sm font-medium mb-3">Vertical List (Grid = 1)</p>
          <ChoiceBox
            v-model="layoutVal"
            :options="[
              {
