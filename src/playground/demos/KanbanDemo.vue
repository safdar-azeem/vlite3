...
const dataSlots = ref({
  'ideas': [{ id: 'idea1', title: 'Add dark mode' }, { id: 'idea2', title: 'Improve accessibility' }],
  ...
  <div class="space-y-12 pb-20">
    ...
    <DemoSection title="Basic Kanban (Static Data)" :code="sourceCode">
      <div class="h-[500px]">
        ...
        >
           <template #item="{ item }">
              <div class="bg-card p-3 rounded-lg shadow-sm border border-border cursor-grab active:cursor-grabbing hover:border-primary transition-colors">
      ...
      <div class="h-[500px]">
        ...
        >
          ...
          <template #append-item="{ items }">
            <div class="mt-4 pt-4 border-t border-border/50 text-center text-xs text-muted-foreground">
    ...
    <DemoSection title="Lazy Loaded Columns (Infinite Scroll)" :code="sourceCode">
      ...
      <p class="mt-4 text-sm text-muted-foreground italic">Scroll to the bottom of the Backlog or Review columns to trigger lazy loading of the next page. Notice the minimal spinner at the bottom without shifting existing items.</p>
    </DemoSection>
  </div>
</template>
